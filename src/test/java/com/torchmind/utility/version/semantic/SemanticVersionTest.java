...
/**
 * Provides test cases for {@link com.torchmind.utility.version.semantic.SemanticVersion}.
 *
...
public class SemanticVersionTest {
         ...
         */
        private void assertVersion (@Nonnull SemanticVersion version, @Nonnegative int major, @Nonnegative int minor, @Nonnegative int patch, @Nullable String extra, @Nullable String metadata) {
        ...
        /**
         * Tests {@link com.torchmind.utility.version.semantic.SemanticVersion#newerThan(SemanticVersion)} and
         * {@link com.torchmind.utility.version.semantic.SemanticVersion#olderThan(SemanticVersion)}.
         */
        @Test
        public void testCompare () {
                SemanticVersion version00 = SemanticVersion.builder ().major (0).build (); // 0.0.0
                SemanticVersion version01 = SemanticVersion.builder ().major (1).extra ("snapshot").build (); // 1.0.0-snapshot
                SemanticVersion version02 = SemanticVersion.builder ().major (1).extra ("snapshot.1").build (); // 1.0.0-snapshot.1
                SemanticVersion version03 = SemanticVersion.builder ().major (1).extra ("snapshot.2").build (); // 1.0.0-snapshot.2
                SemanticVersion version04 = SemanticVersion.builder ().major (1).extra ("snapshot.3").build (); // 1.0.0-snapshot.3
                SemanticVersion version05 = SemanticVersion.builder ().major (1).extra ("alpha").build (); // 1.0.0-alpha
                SemanticVersion version06 = SemanticVersion.builder ().major (1).extra ("alpha.1").build (); // 1.0.0-alpha.1
                SemanticVersion version07 = SemanticVersion.builder ().major (1).extra ("alpha.2").build (); // 1.0.0-alpha.2
                SemanticVersion version08 = SemanticVersion.builder ().major (1).extra ("alpha.3").build (); // 1.0.0-alpha.3
                SemanticVersion version09 = SemanticVersion.builder ().major (1).extra ("beta").build (); // 1.0.0-beta
                SemanticVersion version10 = SemanticVersion.builder ().major (1).extra ("beta.1").build (); // 1.0.0-beta.1
                SemanticVersion version11 = SemanticVersion.builder ().major (1).extra ("beta.2").build (); // 1.0.0-beta.2
                SemanticVersion version12 = SemanticVersion.builder ().major (1).extra ("beta.3").build (); // 1.0.0-beta.3
                SemanticVersion version13 = SemanticVersion.builder ().major (1).extra ("rc").build (); // 1.0.0-rc
                SemanticVersion version14 = SemanticVersion.builder ().major (1).extra ("rc.1").build (); // 1.0.0-rc.1
                SemanticVersion version15 = SemanticVersion.builder ().major (1).extra ("rc.2").build (); // 1.0.0-rc.2
                SemanticVersion version16 = SemanticVersion.builder ().major (1).extra ("rc.3").build (); // 1.0.0-rc.3
                ...
                SemanticVersion version30 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha").build (); // 0.0.0-alpha
                SemanticVersion version31 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).build (); // 0.0.0
                SemanticVersion version32 = SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).build (); // 0.0.1
                SemanticVersion version33 = SemanticVersion.builder ().major (0).minor (1).patch (0).extra (null).build (); // 0.1.0
                SemanticVersion version34 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).build (); // 1.0.0
        ...
        /**
         * Tests {@link com.torchmind.utility.version.semantic.SemanticVersion#equals(SemanticVersion)}.
         */
        @Test
        public void testEquals () {
                SemanticVersion version00 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version01 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version02 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).metadata ("metadata").build ();

                SemanticVersion version03 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot").metadata (null).build ();
                SemanticVersion version04 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot").metadata (null).build ();
                SemanticVersion version05 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot").metadata ("metadata").build ();

                SemanticVersion version06 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot.1").metadata (null).build ();
                SemanticVersion version07 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot.1").metadata (null).build ();
                SemanticVersion version08 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot.1").metadata ("metadata").build ();

                SemanticVersion version09 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot.2").metadata (null).build ();
                SemanticVersion version10 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot.2").metadata (null).build ();
                SemanticVersion version11 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot.2").metadata ("metadata").build ();

                SemanticVersion version12 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha").metadata (null).build ();
                SemanticVersion version13 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha").metadata (null).build ();
                SemanticVersion version14 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a").metadata (null).build ();
                SemanticVersion version15 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha").metadata ("metadata").build ();
                SemanticVersion version16 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a").metadata ("metadata").build ();

                SemanticVersion version17 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha.1").metadata (null).build ();
                SemanticVersion version18 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha.1").metadata (null).build ();
                SemanticVersion version19 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a.1").metadata (null).build ();
                SemanticVersion version20 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha.1").metadata ("metadata").build ();
                SemanticVersion version21 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a.1").metadata ("metadata").build ();

                SemanticVersion version22 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha.2").metadata (null).build ();
                SemanticVersion version23 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha.2").metadata (null).build ();
                SemanticVersion version24 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a.2").metadata (null).build ();
                SemanticVersion version25 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha.2").metadata ("metadata").build ();
                SemanticVersion version26 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a.2").metadata ("metadata").build ();

                SemanticVersion version27 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta").metadata (null).build ();
                SemanticVersion version28 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta").metadata (null).build ();
                SemanticVersion version29 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b").metadata (null).build ();
                SemanticVersion version30 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta").metadata ("metadata").build ();
                SemanticVersion version31 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b").metadata ("metadata").build ();

                SemanticVersion version32 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta.1").metadata (null).build ();
                SemanticVersion version33 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta.1").metadata (null).build ();
                SemanticVersion version34 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b.1").metadata (null).build ();
                SemanticVersion version35 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta.1").metadata ("metadata").build ();
                SemanticVersion version36 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b.1").metadata ("metadata").build ();

                SemanticVersion version37 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta.2").metadata (null).build ();
                SemanticVersion version38 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta.2").metadata (null).build ();
                SemanticVersion version39 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b.2").metadata (null).build ();
                SemanticVersion version40 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta.2").metadata ("metadata").build ();
                SemanticVersion version41 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b.2").metadata ("metadata").build ();

                SemanticVersion version42 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc").metadata (null).build ();
                SemanticVersion version43 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc").metadata (null).build ();
                SemanticVersion version44 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc").metadata ("metadata").build ();

                SemanticVersion version45 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc.1").metadata (null).build ();
                SemanticVersion version46 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc.1").metadata (null).build ();
                SemanticVersion version47 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc.1").metadata ("metadata").build ();

                SemanticVersion version48 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc.2").metadata (null).build ();
                SemanticVersion version49 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc.2").metadata (null).build ();
                SemanticVersion version50 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc.2").metadata ("metadata").build ();

                SemanticVersion version51 = SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version52 = SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version53 = SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).metadata ("metadata").build ();

                SemanticVersion version54 = SemanticVersion.builder ().major (0).minor (1).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version55 = SemanticVersion.builder ().major (0).minor (1).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version56 = SemanticVersion.builder ().major (0).minor (1).patch (0).extra (null).metadata ("metadata").build ();

                SemanticVersion version57 = SemanticVersion.builder ().major (0).minor (1).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version58 = SemanticVersion.builder ().major (0).minor (1).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version59 = SemanticVersion.builder ().major (0).minor (1).patch (1).extra (null).metadata ("metadata").build ();

                SemanticVersion version60 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version61 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version62 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).metadata ("metadata").build ();

                SemanticVersion version63 = SemanticVersion.builder ().major (1).minor (0).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version64 = SemanticVersion.builder ().major (1).minor (0).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version65 = SemanticVersion.builder ().major (1).minor (0).patch (1).extra (null).metadata ("metadata").build ();

                SemanticVersion version66 = SemanticVersion.builder ().major (1).minor (1).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version67 = SemanticVersion.builder ().major (1).minor (1).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version68 = SemanticVersion.builder ().major (1).minor (1).patch (0).extra (null).metadata ("metadata").build ();

                SemanticVersion version69 = SemanticVersion.builder ().major (1).minor (1).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version70 = SemanticVersion.builder ().major (1).minor (1).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version71 = SemanticVersion.builder ().major (1).minor (1).patch (1).extra (null).metadata ("metadata").build ();
        ...
        public void testHashCode () {
                SemanticVersion version01 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot").metadata (null).build ();
                SemanticVersion version02 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot").metadata (null).build ();
                SemanticVersion version03 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot").metadata ("metadata").build ();

                SemanticVersion version04 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot.1").metadata (null).build ();
                SemanticVersion version05 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot.1").metadata (null).build ();
                SemanticVersion version06 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("snapshot.1").metadata ("metadata").build ();

                SemanticVersion version07 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha").metadata (null).build ();
                SemanticVersion version08 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha").metadata (null).build ();
                SemanticVersion version09 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha").metadata ("metadata").build ();
                SemanticVersion version10 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a").metadata (null).build ();
                SemanticVersion version11 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a").metadata (null).build ();
                SemanticVersion version12 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a").metadata ("metadata").build ();

                SemanticVersion version13 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha.1").metadata (null).build ();
                SemanticVersion version14 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha.1").metadata (null).build ();
                SemanticVersion version15 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha.1").metadata ("metadata").build ();
                SemanticVersion version16 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a.1").metadata (null).build ();
                SemanticVersion version17 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a.1").metadata (null).build ();
                SemanticVersion version18 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("a.1").metadata ("metadata").build ();

                SemanticVersion version19 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta").metadata (null).build ();
                SemanticVersion version20 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta").metadata (null).build ();
                SemanticVersion version21 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta").metadata ("metadata").build ();
                SemanticVersion version22 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b").metadata (null).build ();
                SemanticVersion version23 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b").metadata (null).build ();
                SemanticVersion version24 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b").metadata ("metadata").build ();

                SemanticVersion version25 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta.1").metadata (null).build ();
                SemanticVersion version26 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta.1").metadata (null).build ();
                SemanticVersion version27 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("beta.1").metadata ("metadata").build ();
                SemanticVersion version28 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b.1").metadata (null).build ();
                SemanticVersion version29 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b.1").metadata (null).build ();
                SemanticVersion version30 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("b.1").metadata ("metadata").build ();

                SemanticVersion version31 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc").metadata (null).build ();
                SemanticVersion version32 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc").metadata (null).build ();
                SemanticVersion version33 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc").metadata ("metadata").build ();

                SemanticVersion version34 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc.1").metadata (null).build ();
                SemanticVersion version35 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc.1").metadata (null).build ();
                SemanticVersion version36 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("rc.1").metadata ("metadata").build ();

                SemanticVersion version37 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version38 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version39 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).metadata ("metadata").build ();

                SemanticVersion version40 = SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version41 = SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version42 = SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).metadata ("metadata").build ();

                SemanticVersion version43 = SemanticVersion.builder ().major (0).minor (1).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version44 = SemanticVersion.builder ().major (0).minor (1).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version45 = SemanticVersion.builder ().major (0).minor (1).patch (1).extra (null).metadata ("metadata").build ();

                SemanticVersion version46 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version47 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version48 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).metadata ("metadata").build ();

                SemanticVersion version49 = SemanticVersion.builder ().major (1).minor (0).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version50 = SemanticVersion.builder ().major (1).minor (0).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version51 = SemanticVersion.builder ().major (1).minor (0).patch (1).extra (null).metadata ("metadata").build ();

                SemanticVersion version52 = SemanticVersion.builder ().major (1).minor (1).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version53 = SemanticVersion.builder ().major (1).minor (1).patch (0).extra (null).metadata (null).build ();
                SemanticVersion version54 = SemanticVersion.builder ().major (1).minor (1).patch (0).extra (null).metadata ("metadata").build ();

                SemanticVersion version55 = SemanticVersion.builder ().major (1).minor (1).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version56 = SemanticVersion.builder ().major (1).minor (1).patch (1).extra (null).metadata (null).build ();
                SemanticVersion version57 = SemanticVersion.builder ().major (1).minor (1).patch (1).extra (null).metadata ("metadata").build ();
        ...
        /**
         * Tests {@link SemanticVersion#extra(String)}, {@link SemanticVersion#major(int)},
         * {@link SemanticVersion#metadata(String)}, {@link SemanticVersion#minor(int)} and
         * {@link SemanticVersion#patch(int)}.
         */
        @Test
        public void testMutate () {
                SemanticVersion version = SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).metadata (null).build ();
        ...
        /**
         * Tests {@link com.torchmind.utility.version.semantic.SemanticVersion#of(String)}.
         */
        @Test
        public void testParse () {
                ...
                this.assertVersion (SemanticVersion.of ("0.0+metadata-snapshot"), 0, 0, 0, "snapshot", "metadata");
                this.assertVersion (SemanticVersion.of ("0.0-snapshot+metadata"), 0, 0, 0, "snapshot", "metadata");

                this.assertVersion (SemanticVersion.of ("0.0-snapshot.1"), 0, 0, 0, "snapshot.1", null);
                this.assertVersion (SemanticVersion.of ("0.0+metadata-snapshot.1"), 0, 0, 0, "snapshot.1", "metadata");
                this.assertVersion (SemanticVersion.of ("0.0-snapshot.1+metadata"), 0, 0, 0, "snapshot.1", "metadata");

                this.assertVersion (SemanticVersion.of ("0.0-snapshot.2"), 0, 0, 0, "snapshot.2", null);
                this.assertVersion (SemanticVersion.of ("0.0+metadata-snapshot.2"), 0, 0, 0, "snapshot.2", "metadata");
                this.assertVersion (SemanticVersion.of ("0.0-snapshot.2+metadata"), 0, 0, 0, "snapshot.2", "metadata");
        ...
        /**
         * Tests {@link com.torchmind.utility.version.semantic.SemanticVersion#range(String)}.
         */
        @Test
        ...
        public void testStability () {
                SemanticVersion version00 = SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).build ();
                SemanticVersion version01 = SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).build ();
                SemanticVersion version02 = SemanticVersion.builder ().major (0).minor (1).patch (0).extra (null).build ();
                SemanticVersion version03 = SemanticVersion.builder ().major (0).minor (1).patch (1).extra (null).build ();
                SemanticVersion version04 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).build ();
                SemanticVersion version05 = SemanticVersion.builder ().major (1).minor (0).patch (1).extra (null).build ();
                SemanticVersion version06 = SemanticVersion.builder ().major (1).minor (1).patch (0).extra (null).build ();
                SemanticVersion version07 = SemanticVersion.builder ().major (1).minor (1).patch (1).extra (null).build ();
                SemanticVersion version08 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).metadata ("metadata").build ();

                SemanticVersion version09 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("snapshot").build ();
                SemanticVersion version10 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("snapshot.1").build ();
                SemanticVersion version11 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("snapshot.2").build ();
                SemanticVersion version12 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("alpha").build ();
                SemanticVersion version13 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("alpha.1").build ();
                SemanticVersion version14 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("alpha.2").build ();
                SemanticVersion version15 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("a").build ();
                SemanticVersion version16 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("a.1").build ();
                SemanticVersion version17 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("a.2").build ();
                SemanticVersion version18 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("beta").build ();
                SemanticVersion version19 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("beta.1").build ();
                SemanticVersion version20 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("beta.2").build ();
                SemanticVersion version21 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("b").build ();
                SemanticVersion version22 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("b.1").build ();
                SemanticVersion version23 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("b.2").build ();
                SemanticVersion version24 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("rc").build ();
                SemanticVersion version25 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("rc.1").build ();
                SemanticVersion version26 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("rc.2").build ();
                SemanticVersion version27 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("foo").build ();
                SemanticVersion version28 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("foo.1").build ();
                SemanticVersion version29 = SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("foo.2").build ();
        ...
        public void testToString () {
                Assert.assertEquals ("0.0-alpha", SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha").metadata (null).build ().toString ());
                Assert.assertEquals ("0.0-alpha+metadata", SemanticVersion.builder ().major (0).minor (0).patch (0).extra ("alpha").metadata ("metadata").build ().toString ());
                Assert.assertEquals ("0.0", SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).metadata (null).build ().toString ());
                Assert.assertEquals ("0.0+metadata", SemanticVersion.builder ().major (0).minor (0).patch (0).extra (null).metadata ("metadata").build ().toString ());

                Assert.assertEquals ("0.0.1-alpha", SemanticVersion.builder ().major (0).minor (0).patch (1).extra ("alpha").metadata (null).build ().toString ());
                Assert.assertEquals ("0.0.1-alpha+metadata", SemanticVersion.builder ().major (0).minor (0).patch (1).extra ("alpha").metadata ("metadata").build ().toString ());
                Assert.assertEquals ("0.0.1", SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).metadata (null).build ().toString ());
                Assert.assertEquals ("0.0.1+metadata", SemanticVersion.builder ().major (0).minor (0).patch (1).extra (null).metadata ("metadata").build ().toString ());

                Assert.assertEquals ("0.1-alpha", SemanticVersion.builder ().major (0).minor (1).patch (0).extra ("alpha").metadata (null).build ().toString ());
                Assert.assertEquals ("0.1-alpha+metadata", SemanticVersion.builder ().major (0).minor (1).patch (0).extra ("alpha").metadata ("metadata").build ().toString ());
                Assert.assertEquals ("0.1", SemanticVersion.builder ().major (0).minor (1).patch (0).extra (null).metadata (null).build ().toString ());
                Assert.assertEquals ("0.1+metadata", SemanticVersion.builder ().major (0).minor (1).patch (0).extra (null).metadata ("metadata").build ().toString ());

                Assert.assertEquals ("0.1.1-alpha", SemanticVersion.builder ().major (0).minor (1).patch (1).extra ("alpha").metadata (null).build ().toString ());
                Assert.assertEquals ("0.1.1-alpha+metadata", SemanticVersion.builder ().major (0).minor (1).patch (1).extra ("alpha").metadata ("metadata").build ().toString ());
                Assert.assertEquals ("0.1.1", SemanticVersion.builder ().major (0).minor (1).patch (1).extra (null).metadata (null).build ().toString ());
                Assert.assertEquals ("0.1.1+metadata", SemanticVersion.builder ().major (0).minor (1).patch (1).extra (null).metadata ("metadata").build ().toString ());

                Assert.assertEquals ("1.0-alpha", SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("alpha").metadata (null).build ().toString ());
                Assert.assertEquals ("1.0-alpha+metadata", SemanticVersion.builder ().major (1).minor (0).patch (0).extra ("alpha").metadata ("metadata").build ().toString ());
                Assert.assertEquals ("1.0", SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).metadata (null).build ().toString ());
                Assert.assertEquals ("1.0+metadata", SemanticVersion.builder ().major (1).minor (0).patch (0).extra (null).metadata ("metadata").build ().toString ());

                Assert.assertEquals ("1.0.1-alpha", SemanticVersion.builder ().major (1).minor (0).patch (1).extra ("alpha").metadata (null).build ().toString ());
                Assert.assertEquals ("1.0.1-alpha+metadata", SemanticVersion.builder ().major (1).minor (0).patch (1).extra ("alpha").metadata ("metadata").build ().toString ());
                Assert.assertEquals ("1.0.1", SemanticVersion.builder ().major (1).minor (0).patch (1).extra (null).metadata (null).build ().toString ());
                Assert.assertEquals ("1.0.1+metadata", SemanticVersion.builder ().major (1).minor (0).patch (1).extra (null).metadata ("metadata").build ().toString ());

                Assert.assertEquals ("1.1-alpha", SemanticVersion.builder ().major (1).minor (1).patch (0).extra ("alpha").metadata (null).build ().toString ());
                Assert.assertEquals ("1.1-alpha+metadata", SemanticVersion.builder ().major (1).minor (1).patch (0).extra ("alpha").metadata ("metadata").build ().toString ());
                Assert.assertEquals ("1.1", SemanticVersion.builder ().major (1).minor (1).patch (0).extra (null).metadata (null).build ().toString ());
                Assert.assertEquals ("1.1+metadata", SemanticVersion.builder ().major (1).minor (1).patch (0).extra (null).metadata ("metadata").build ().toString ());

                Assert.assertEquals ("1.1.1-alpha", SemanticVersion.builder ().major (1).minor (1).patch (1).extra ("alpha").metadata (null).build ().toString ());
                Assert.assertEquals ("1.1.1-alpha+metadata", SemanticVersion.builder ().major (1).minor (1).patch (1).extra ("alpha").metadata ("metadata").build ().toString ());
                Assert.assertEquals ("1.1.1", SemanticVersion.builder ().major (1).minor (1).patch (1).extra (null).metadata (null).build ().toString ());
                Assert.assertEquals ("1.1.1+metadata", SemanticVersion.builder ().major (1).minor (1).patch (1).extra (null).metadata ("metadata").build ().toString ());
        }

        /**
         * Provides test cases for {@link com.torchmind.utility.version.semantic.SemanticVersion.Builder}.
         */
        @RunWith (MockitoJUnitRunner.class)
        public static class BuilderTest {

                /**
                 * Tests {@link com.torchmind.utility.version.semantic.SemanticVersion.Builder#build()}.
                 */
                @Test
                public void testBuild () {
                        ...
                        SemanticVersion.Builder builder03 = SemanticVersion.builder ().extra ("extra").metadata ("metadata");
                        ...
                        SemanticVersion.Builder builder07 = SemanticVersion.builder ().patch (1).extra ("extra").metadata ("metadata");
                        ...
                        SemanticVersion.Builder builder11 = SemanticVersion.builder ().minor (1).extra ("extra").metadata ("metadata");
                        SemanticVersion.Builder builder12 = SemanticVersion.builder ().minor (1).patch (1);
                        SemanticVersion.Builder builder13 = SemanticVersion.builder ().minor (1).patch (1).metadata ("metadata");
                        SemanticVersion.Builder builder14 = SemanticVersion.builder ().minor (1).patch (1).extra ("extra");
                        SemanticVersion.Builder builder15 = SemanticVersion.builder ().minor (1).patch (1).extra ("extra").metadata ("metadata");
                        ...
                        SemanticVersion.Builder builder19 = SemanticVersion.builder ().major (1).extra ("extra").metadata ("metadata");
                        SemanticVersion.Builder builder20 = SemanticVersion.builder ().major (1).patch (1);
                        SemanticVersion.Builder builder21 = SemanticVersion.builder ().major (1).patch (1).metadata ("metadata");
                        SemanticVersion.Builder builder22 = SemanticVersion.builder ().major (1).patch (1).extra ("extra");
                        SemanticVersion.Builder builder23 = SemanticVersion.builder ().major (1).patch (1).extra ("extra").metadata ("metadata");
                        SemanticVersion.Builder builder24 = SemanticVersion.builder ().major (1).minor (1);
                        SemanticVersion.Builder builder25 = SemanticVersion.builder ().major (1).minor (1).metadata ("metadata");
                        SemanticVersion.Builder builder26 = SemanticVersion.builder ().major (1).minor (1).extra ("extra");
                        SemanticVersion.Builder builder27 = SemanticVersion.builder ().major (1).minor (1).extra ("extra").metadata ("metadata");
                        SemanticVersion.Builder builder28 = SemanticVersion.builder ().major (1).minor (1).patch (1);
                        SemanticVersion.Builder builder29 = SemanticVersion.builder ().major (1).minor (1).patch (1).metadata ("metadata");
                        SemanticVersion.Builder builder30 = SemanticVersion.builder ().major (1).minor (1).patch (1).extra ("extra");
                        SemanticVersion.Builder builder31 = SemanticVersion.builder ().major (1).minor (1).patch (1).extra ("extra").metadata ("metadata");
                ...
                /**
                 * Tests {@link com.torchmind.utility.version.semantic.SemanticVersion#builder(SemanticVersion)}.
                 */
                @Test
                public void testCopy () {
                        SemanticVersion version = SemanticVersion.builder ().major (1).minor (1).patch (1).extra ("test").metadata ("test").build ();
                ...
                /**
                 * Tests {@link com.torchmind.utility.version.semantic.SemanticVersion.Builder#reset()}
                 */
                @Test
                public void testReset () {
                        SemanticVersion.Builder builder = SemanticVersion.builder ().major (1).minor (1).patch (1).extra ("test").metadata ("test");
